...
def verify_last_navigation_log(expected_action):
    """
    ...
    try:
        ...
        cmd = ["adb", "exec-out", "run-as", "com.example.GaoDe", "cat", "files/1_message_history.json"]
...
if __name__ == "__main__":
    ...
    success = verify_last_navigation_log(expected_action)
